...
const defaultProducts: ProductCandidate[] = [
  ...
  { id: "kids-tablet", name: "Kids learning tablet", query: "kids learning tablet sale Serbia", targetPriceUsd: 90 },
  { id: "robot-toy", name: "Programmable robot toy", query: "programmable robot toy deal Serbia", targetPriceUsd: 75 },
  { id: "stem-kit", name: "STEM electronics kit", query: "STEM electronics kit discount Serbia", targetPriceUsd: 65 },
  { id: "rc-car", name: "Hobby RC car", query: "hobby RC car sale Serbia", targetPriceUsd: 130 },
  { id: "drone-mini", name: "Mini beginner drone", query: "mini beginner drone deal Serbia", targetPriceUsd: 90 },
  { id: "lego-storage", name: "Toy brick storage table", query: "toy brick storage table discount Serbia", targetPriceUsd: 80 },
  { id: "baby-monitor", name: "Video baby monitor", query: "video baby monitor sale Serbia", targetPriceUsd: 120 },
  { id: "bottle-warmer", name: "Smart bottle warmer", query: "smart bottle warmer deal Serbia", targetPriceUsd: 50 },
  { id: "baby-food-maker", name: "Baby food maker", query: "baby food maker discount Serbia", targetPriceUsd: 95 },
  { id: "diaper-pail", name: "Odor locking diaper pail", query: "odor locking diaper pail sale Serbia", targetPriceUsd: 45 },
  { id: "travel-stroller", name: "Compact travel stroller", query: "compact travel stroller deal Serbia", targetPriceUsd: 220 },
  { id: "car-seat", name: "Convertible child car seat", query: "convertible child car seat discount Serbia", targetPriceUsd: 260 },
  { id: "baby-carrier", name: "Ergonomic baby carrier", query: "ergonomic baby carrier sale Serbia", targetPriceUsd: 110 },
  { id: "portable-crib", name: "Portable travel crib", query: "portable travel crib deal Serbia", targetPriceUsd: 150 },
  { id: "high-chair", name: "Foldable high chair", query: "foldable high chair discount Serbia", targetPriceUsd: 95 },
  { id: "pet-gps-collar", name: "Pet GPS collar", query: "pet GPS collar sale Serbia", targetPriceUsd: 120 },
  { id: "automatic-litter-box", name: "Automatic litter box", query: "automatic litter box deal Serbia", targetPriceUsd: 320 },
  { id: "aquarium-filter", name: "Smart aquarium filter", query: "smart aquarium filter discount Serbia", targetPriceUsd: 80 },
  { id: "aquarium-light", name: "Programmable aquarium light", query: "programmable aquarium light sale Serbia", targetPriceUsd: 70 },
  { id: "terrarium-thermostat", name: "Terrarium thermostat", query: "terrarium thermostat deal Serbia", targetPriceUsd: 55 },
  { id: "wine-opener", name: "Electric wine opener", query: "electric wine opener discount Serbia", targetPriceUsd: 35 },
  { id: "cocktail-smoker", name: "Cocktail smoker kit", query: "cocktail smoker kit sale Serbia", targetPriceUsd: 55 },
  { id: "knife-sharpener", name: "Electric knife sharpener", query: "electric knife sharpener deal Serbia", targetPriceUsd: 60 },
  { id: "mandoline-slicer", name: "Professional mandoline slicer", query: "professional mandoline slicer discount Serbia", targetPriceUsd: 45 },
  { id: "cast-iron-pan", name: "Enameled cast iron pan", query: "enameled cast iron pan sale Serbia", targetPriceUsd: 85 },
  { id: "pizza-oven", name: "Outdoor pizza oven", query: "outdoor pizza oven deal Serbia", targetPriceUsd: 280 },
  { id: "bbq-thermometer", name: "Wireless BBQ thermometer", query: "wireless BBQ thermometer discount Serbia", targetPriceUsd: 75 },
  { id: "pellet-grill", name: "Portable pellet grill", query: "portable pellet grill sale Serbia", targetPriceUsd: 360 },
  { id: "cooler-box", name: "Premium cooler box", query: "premium cooler box deal Serbia", targetPriceUsd: 150 },
  { id: "folding-wagon", name: "Folding utility wagon", query: "folding utility wagon discount Serbia", targetPriceUsd: 120 },
  { id: "pressure-canner", name: "Pressure canner", query: "pressure canner sale Serbia", targetPriceUsd: 180 },
  { id: "grain-mill", name: "Electric grain mill", query: "electric grain mill deal Serbia", targetPriceUsd: 190 },
  { id: "bread-maker", name: "Automatic bread maker", query: "automatic bread maker discount Serbia", targetPriceUsd: 130 },
  { id: "yogurt-maker", name: "Automatic yogurt maker", query: "automatic yogurt maker sale Serbia", targetPriceUsd: 55 },
  { id: "pasta-maker", name: "Electric pasta maker", query: "electric pasta maker deal Serbia", targetPriceUsd: 160 },
  { id: "ice-cream-maker", name: "Compressor ice cream maker", query: "compressor ice cream maker discount Serbia", targetPriceUsd: 230 },
